                ...
                <div class="col-md-4 services align-self-stretch px-4 ftco-animate">
                    <div class="d-block services-wrap text-center">
                        ...
                        <div class="media-body py-4 px-3">
                            ...
                            <p>
                                <a href="{{ route('hotel.rooms', $hotel->id)}}" class="btn btn-primary">View rooms</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="room-wrap d-md-flex">
                        ...
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                ...
                                <p class="pt-1">
                                    <a href="{{ route('hotel.rooms.details', $room->id)}}" class="btn-custom px-3 py-2">
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-6 wrap-about">
                    <div class="img img-2 mb-4" style="background-image: url('{{ asset('assets/images/image_2.jpg') }}');"></div>
                ...
                <div class="col-md-6 wrap-about ftco-animate">
                    ...
                    <div class="pl-md-5">
                        ...
                        <div class="row">
                            ...
                            @foreach ([
                                'Tea Coffee', 'Hot Showers', 'Laundry', 'Air Conditioning',
                                'Free Wifi', 'Kitchen', 'Ironing', 'Lockers'
                            ] as $item)
                            <div class="services-2 col-lg-6 d-flex w-100">
                                <div class="icon d-flex justify-content-center align-items-center">
                                    {{-- flaticon-first digunakan sebagai placeholder icon --}}
